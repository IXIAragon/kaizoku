/datum/voicepack/female/noble/get_sound(soundin, modifiers)
	var/used
	switch(modifiers)
		if("old")
	...
	if(!used)
		switch(soundin)
            ...
            if("laugh")
                used = list('sound/vo/female/old/noble/laugh (1).ogg','sound/vo/female/old/noble/laugh (2).ogg','sound/vo/female/old/noble/laugh (3).ogg')
			if("haltyell")
